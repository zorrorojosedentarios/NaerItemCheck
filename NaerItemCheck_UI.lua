...
-- Botón del Minimapa
local NIC_MinimapBtn = CreateFrame("Button", "NaerItemCheckMinimapButton", Minimap)
NIC_MinimapBtn:SetSize(32, 32)
NIC_MinimapBtn:SetFrameStrata("MEDIUM")
NIC_MinimapBtn:SetPoint("TOPRIGHT", Minimap, "TOPRIGHT", -2, -2)

local icon = NIC_MinimapBtn:CreateTexture(nil, "ARTWORK")
icon:SetSize(20, 20)
icon:SetPoint("TOPLEFT", 7, -5)
icon:SetTexture("Interface\\AddOns\\NaerItemCheck\\naeritemcheck.tga")
...
NIC_MinimapBtn:SetScript("OnEnter", function(self)
    GameTooltip:SetOwner(self, "ANCHOR_LEFT")
    GameTooltip:AddLine("NaerItemCheck")
    GameTooltip:AddLine("|cffffffffClic para abrir/cerrar|r", 1, 1, 1, true)
    GameTooltip:Show()
end)
NIC_MinimapBtn:SetScript("OnLeave", function(self)
    GameTooltip:Hide()
end)
